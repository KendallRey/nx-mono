...
export const DateRangePicker: React.FC<IDateRangePicker> = (props) => {
  ...
  return (
    <RDR onChange={_onChange} moveRangeOnFirstSelection={false} months={2} ranges={[range]} direction="horizontal" />
  );
};
...
export const DateRange: React.FC<IDateRange> = (props) => {
  ...
  return <DR editableDateInputs={true} onChange={_onChange} moveRangeOnFirstSelection={false} ranges={[range]} />;
};
